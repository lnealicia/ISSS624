...
Note: No missing data, data is complete

Append Coordinates

```{r}
merged = merge(csv, found, by.x= 'postal_code', by.y = 'results.POSTAL', all=TRUE)
write.csv(merged, file = "data/geospatial/HDB.csv")
```
...
# Combine the maps
final_map <- tmap_arrange(business_map, mrtexit_map, finserv_map, asp = 1, ncol = 3)
