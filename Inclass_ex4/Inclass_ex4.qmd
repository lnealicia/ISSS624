...
inter_zonal_flow <- inter_zonal_flow %>%
  rename(
    uncTRIPS = matches("uncSIM$fitted.values"),
    orcTRIPS = matches("orcSIM$fitted.values"),
    decTRIPS = matches("decSIM$fitted.values"),
    dbcTRIPS = matches("dbcSIM$fitted.values")
  )
```

```{r}
inter_zonal_flow$TRIPS <- as.numeric(inter_zonal_flow$TRIPS)
inter_zonal_flow$uncTRIPS <- as.numeric(inter_zonal_flow$uncTRIPS)
inter_zonal_flow$orcTRIPS <- as.numeric(inter_zonal_flow$orcTRIPS)
inter_zonal_flow$decTRIPS <- as.numeric(inter_zonal_flow$decTRIPS)
inter_zonal_flow$dbcTRIPS <- as.numeric(inter_zonal_flow$dbcTRIPS)
