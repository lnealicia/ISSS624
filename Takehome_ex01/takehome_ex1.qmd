...
quantile <- tm_shape(total_trips_by_grid_wdmp_sf) +
  tm_fill("total_trips",
          n = 5,
          style = "quantile") +
  tm_borders(alpha = 0.5) +
...
quantile <- tm_shape(total_trips_by_grid_wdap_sf) +
  tm_fill("total_trips",
          n = 5,
          style = "quantile") +
  tm_borders(alpha = 0.5) +
...
quantile <- tm_shape(total_trips_by_grid_hmp_sf) +
  tm_fill("total_trips",
          n = 5,
          style = "quantile") +
  tm_borders(alpha = 0.5) +
...
quantile <- tm_shape(total_trips_by_grid_hep_sf) +
  tm_fill("total_trips",
          n = 5,
          style = "quantile") +
  tm_borders(alpha = 0.5) +
