...
::: {.callout-tip title="Statistical Conclusion" style="color: green"}
Weekday Afternoon Peak 5pm-8pm What statistical observations can you draw from the LISA map above?
:::
...
::: {.callout-tip title="Statistical Conclusion" style="color: green"}
Weekend/Holiday Morning Peak 11am-2pm What statistical observations can you draw from the LISA map above?
:::
